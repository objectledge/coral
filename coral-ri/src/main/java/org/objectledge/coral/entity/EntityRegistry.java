...
/**
 * This class manages 'by id' 'by name' and 'all' registries for a specific entity type.
 */
public class EntityRegistry<E extends Persistent & Entity>
{
    ...
    /**
     * The semantic name of the entity type used in error messages in the plural form.
     */
    ...
    private Set<E> synthetics = new HashSet<E>();
    ...
    public EntityRegistry(Persistence persistence, CacheFactory cacheFactory,
        Instantiator instantiator, Logger log, String kind, final Class<E> type)
     ...
     * @throws EntityDoesNotExistException if the entity with the specified id does not exist.
     */
        ...
        throws EntityDoesNotExistException
    {
        synchronized(byId)
        {
            ...
            if(e == null)
            {
                ...
                if(e == null)
                {
                    throw new EntityDoesNotExistException(kind + " #" + id + " does not exist");
                }
                byId.put(idObj, e);
            }
            return e;
     ...
     * @throws EntityDoesNotExistException if the entity with the specified id does not exist.
     * @throws AmbigousEntityNameException if the name specified denotes more than one entity
     */
     ...
     * <p>
     * This method does not attempt to save the entity to storage - should be used for synthetic
     * entities.
     * </p>
     * 
     ...
     * 
     * @param entity the entity.
     * @throws EntityExistsException if an entity with the same name as the specified already exists
     *         in the system.
     */
        ...
        throws EntityExistsException
    {
        ...
        try
        {
            ...
            if(persistence.exists(((Persistent)entity).getTable(), "name = '" + entity.getName()
                + "'"))
            {
                throw new EntityExistsException(kind + " '" + entity.getName() + "' already exists");
            }
            add(entity);
        ...
        throws EntityExistsException
    {
        ...
        {
            shouldCommit = persistence.getDatabase().beginTransaction();
            if(persistence.exists(((Persistent)entity).getTable(), "name = '" + name + "'"))
            {
                throw new EntityExistsException(kind + " '" + name + "' already exists");
            }
            rename(entity, name);
            persistence.getDatabase().commitTransaction(shouldCommit);
        }
     ...
     */
    public void resolve(List<E> in, Set<E> out)
    {
        synchronized(byName)
        {
            synchronized(byId)
