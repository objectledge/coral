 ...
 */
public class RelationList extends BaseBrowserComponent
{
    
    
    public RelationList(Context context, Logger logger, TableStateManager tableStateManager)
    {
        ...
        throws ProcessingException
    {
        try
        {
            ...
            Relation[] relations = coralSession.getRelationManager().getRelation();
            TableModel model = new ListTableModel(relations, columns);
