/* Generated By:JJTree&JavaCC: Do not edit this line. RelationQueryParserTokenManager.java */
package org.objectledge.coral.relation.query.parser;
import java.io.StringReader;
import java.io.Reader;

public class RelationQueryParserTokenManager implements RelationQueryParserConstants
{
...
"", null, null, null, null, "\53", "\52", null, null, null, null, null, "\73", 
"\50", "\51", "\115\101\120\50", "\173", "\175", 
"\115\101\120\124\122\101\116\123\50", "\41", "\47", "\122\105\123\50", };
...
public RelationQueryParserTokenManager(JavaCharStream stream)
{
   if (JavaCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public RelationQueryParserTokenManager(JavaCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
